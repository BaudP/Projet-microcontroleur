...
SOURCEFILES_QUOTED_IF_SPACED=main.c game.c sound.c glcd.c init1.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/game.p1 ${OBJECTDIR}/sound.p1 ${OBJECTDIR}/glcd.p1 ${OBJECTDIR}/init1.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/game.p1.d ${OBJECTDIR}/sound.p1.d ${OBJECTDIR}/glcd.p1.d ${OBJECTDIR}/init1.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/game.p1 ${OBJECTDIR}/sound.p1 ${OBJECTDIR}/glcd.p1 ${OBJECTDIR}/init1.p1

# Source Files
SOURCEFILES=main.c game.c sound.c glcd.c init1.c
...
${OBJECTDIR}/init1.p1: init1.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/init1.p1.d 
	@${RM} ${OBJECTDIR}/init1.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/init1.p1 init1.c 
	@${FIXDEPS} ${OBJECTDIR}/init1.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
